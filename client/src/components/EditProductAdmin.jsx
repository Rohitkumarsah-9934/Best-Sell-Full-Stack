...
import AddFieldComponent from "../components/AddFieldComponenet";
          ...
          <div className="grid p-3">
            <form className="grid gap-4" onSubmit={handleSubmit}>
                ...
                return (
                  <div className="grid gap-1">
                    ...
                    <input
                      ...
                      required
                      className="bg-blue-50 p-2 outline-none border focus-within:border-yellow-400rounded"
                    />
                  </div>
                );
              })}
              ...
              <div
                ...
                className=" hover:bg-yellow-400 bg-white py-1 px-3 w-32 text-center font-semibold border border-yellow-400 hover:text-neutral-900 cursor-pointer rounded"
              >
                Add Fields
              </div>

              <button className="bg-yellow-300 hover:bg-yellow-400 py-2 rounded font-semibold">
                Update Product
              </button>
            </form>
          </div>
