...
function UploadSubCategoryModel({ close, fetchData }) {
  ...
  return (
    <section className="fixed top-0 right-0 bottom-0 left-0 bg-black/60 z-50 flex items-center justify-center p-4">
          ...
          <div className="grid gap-1">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-3">
              ...
              <label htmlFor="uploadSubCategoryImage">
                <div className="px-4 py-1 border border-yellow-300 text-yellow-400 rounded hover:bg-yellow-300 hover:text-neutral-900 cursor-pointer  ">
                  Upload Image
                </div>
                <input
                  type="file"
